...
function(add_qt_linux_appimage TARGET)
  ...
  add_custom_target(${QT_LINUX_TARGET}
    ...
    COMMAND ${CMAKE_COMMAND} -DALLOW_ENVIRONMENT_VARIABLE=${ALLOW_ENVIRONMENT_VARIABLE} -DAPPRUN_PATH=${CMAKE_CURRENT_BINARY_DIR}/$<CONFIG>/AppDir -DTARGET_FILE_NAME=$<TARGET_FILE_NAME:${TARGET}> -P "${CMAKE_CURRENT_LIST_DIR }/GenerateAppRun.cmake"
